...
var knownFormats = map[string]string{
	"*bytes.Buffer %s":                                "",
	"*cmd/compile/i/gc.Mpflt %v":               "",
	"*cmd/compile/i/gc.Mpint %v":               "",
	"*cmd/compile/i/gc.Node %#v":               "",
	"*cmd/compile/i/gc.Node %+S":               "",
	"*cmd/compile/i/gc.Node %+v":               "",
	"*cmd/compile/i/gc.Node %0j":               "",
	"*cmd/compile/i/gc.Node %L":                "",
	"*cmd/compile/i/gc.Node %S":                "",
	"*cmd/compile/i/gc.Node %j":                "",
	"*cmd/compile/i/gc.Node %p":                "",
	"*cmd/compile/i/gc.Node %v":                "",
	"*cmd/compile/i/ssa.Block %s":              "",
	"*cmd/compile/i/ssa.Block %v":              "",
	"*cmd/compile/i/ssa.Func %s":               "",
	"*cmd/compile/i/ssa.Func %v":               "",
	"*cmd/compile/i/ssa.Register %s":           "",
	"*cmd/compile/i/ssa.Register %v":           "",
	"*cmd/compile/i/ssa.SparseTreeNode %v":     "",
	"*cmd/compile/i/ssa.Value %s":              "",
	"*cmd/compile/i/ssa.Value %v":              "",
	"*cmd/compile/i/ssa.sparseTreeMapEntry %v": "",
	"*cmd/compile/i/types.Field %p":            "",
	"*cmd/compile/i/types.Field %v":            "",
	"*cmd/compile/i/types.Sym %+v":             "",
	"*cmd/compile/i/types.Sym %0S":             "",
	"*cmd/compile/i/types.Sym %S":              "",
	"*cmd/compile/i/types.Sym %p":              "",
	"*cmd/compile/i/types.Sym %v":              "",
	"*cmd/compile/i/types.Type %#v":            "",
	"*cmd/compile/i/types.Type %+v":            "",
	"*cmd/compile/i/types.Type %-S":            "",
	"*cmd/compile/i/types.Type %0S":            "",
	"*cmd/compile/i/types.Type %L":             "",
	"*cmd/compile/i/types.Type %S":             "",
	"*cmd/compile/i/types.Type %p":             "",
	"*cmd/compile/i/types.Type %s":             "",
	"*cmd/compile/i/types.Type %v":             "",
	...
	"[]byte %s":                                       "",
	"[]byte %x":                                       "",
	"[]cmd/compile/i/ssa.Edge %v":              "",
	"[]cmd/compile/i/ssa.ID %v":                "",
	"[]cmd/compile/i/ssa.posetNode %v":         "",
	"[]cmd/compile/i/ssa.posetUndo %v":         "",
	"[]cmd/compile/i/syntax.token %s":          "",
	"[]string %v":                                     "",
	"[]uint32 %v":                                     "",
	"bool %v":                                         "",
	"byte %08b":                                       "",
	"byte %c":                                         "",
	"byte %v":                                         "",
	"cmd/compile/i/arm.shift %d":               "",
	"cmd/compile/i/gc.Class %d":                "",
	"cmd/compile/i/gc.Class %s":                "",
	"cmd/compile/i/gc.Class %v":                "",
	"cmd/compile/i/gc.Ctype %d":                "",
	"cmd/compile/i/gc.Ctype %v":                "",
	"cmd/compile/i/gc.Level %d":                "",
	"cmd/compile/i/gc.Level %v":                "",
	"cmd/compile/i/gc.Nodes %#v":               "",
	"cmd/compile/i/gc.Nodes %+v":               "",
	"cmd/compile/i/gc.Nodes %.v":               "",
	"cmd/compile/i/gc.Nodes %v":                "",
	"cmd/compile/i/gc.Op %#v":                  "",
	"cmd/compile/i/gc.Op %v":                   "",
	"cmd/compile/i/gc.Val %#v":                 "",
	"cmd/compile/i/gc.Val %T":                  "",
	"cmd/compile/i/gc.Val %v":                  "",
	"cmd/compile/i/gc.fmtMode %d":              "",
	"cmd/compile/i/gc.initKind %d":             "",
	"cmd/compile/i/gc.itag %v":                 "",
	"cmd/compile/i/ssa.BranchPrediction %d":    "",
	"cmd/compile/i/ssa.Edge %v":                "",
	"cmd/compile/i/ssa.GCNode %v":              "",
	"cmd/compile/i/ssa.ID %d":                  "",
	"cmd/compile/i/ssa.ID %v":                  "",
	"cmd/compile/i/ssa.LocPair %s":             "",
	"cmd/compile/i/ssa.LocalSlot %s":           "",
	"cmd/compile/i/ssa.LocalSlot %v":           "",
	"cmd/compile/i/ssa.Location %T":            "",
	"cmd/compile/i/ssa.Location %s":            "",
	"cmd/compile/i/ssa.Op %s":                  "",
	"cmd/compile/i/ssa.Op %v":                  "",
	"cmd/compile/i/ssa.ValAndOff %s":           "",
	"cmd/compile/i/ssa.domain %v":              "",
	"cmd/compile/i/ssa.posetNode %v":           "",
	"cmd/compile/i/ssa.posetTestOp %v":         "",
	"cmd/compile/i/ssa.rbrank %d":              "",
	"cmd/compile/i/ssa.regMask %d":             "",
	"cmd/compile/i/ssa.register %d":            "",
	"cmd/compile/i/syntax.Expr %#v":            "",
	"cmd/compile/i/syntax.Node %T":             "",
	"cmd/compile/i/syntax.Operator %s":         "",
	"cmd/compile/i/syntax.Pos %s":              "",
	"cmd/compile/i/syntax.Pos %v":              "",
	"cmd/compile/i/syntax.position %s":         "",
	"cmd/compile/i/syntax.token %q":            "",
	"cmd/compile/i/syntax.token %s":            "",
	"cmd/compile/i/types.EType %d":             "",
	"cmd/compile/i/types.EType %s":             "",
	"cmd/compile/i/types.EType %v":             "",
	"error %v":                                        "",
	"float64 %.2f":                                    "",
	"float64 %.3f":                                    "",
	"float64 %.6g":                                    "",
	...
	"interface{} %s":                                  "",
	"interface{} %v":                                  "",
	"map[*cmd/compile/i/gc.Node]*cmd/compile/i/ssa.Value %v": "",
	"map[cmd/compile/i/ssa.ID]uint32 %v":                            "",
	"reflect.Type %s":                                                      "",
	"rune %#U":                                                             "",
	"rune %c":                                                              "",
	"string %-*s":                                                          "",
